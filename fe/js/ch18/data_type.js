...
/* 
    불린타입은 비교 연산자(관계 연산자)의 결과로 많이 사용된다.
*/
let n1 = 10, n2 =20;
bool1 = n1 > n2; // n1이 n2보다 크다면, >>결과값은 false 
...
console.log('n2 < 20:', n2 < 20 );
console.log('---------------------' );
console.log('n1 == n2:', n1 == n2 ); /* == 값이 같다면 / != 값이 같지 않다면 */
console.log('n1 != n2:', n1 != n2 );
console.log('---------------------논리 연산자' );
console.log(' !(n1 == n2):', !( n1 == n2 ));
console.log(' !(n1 != n2):', ! (n1 != n2 )); /* ! 느낌표는 Not (반대) , 결과를 무조건 반대로 */ 
